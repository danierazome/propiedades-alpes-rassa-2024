...
settings = Config()
app_configs: dict[str, Any] = {"title": "BFF PDA"}
...
async def app_startup():
    global tasks
    global eventos
    task1 = asyncio.ensure_future(suscribirse_a_topico("actualizar-plano", "PDA-bff", "public/default/actualizar-plano", eventos=eventos))
    tasks.append(task1)
